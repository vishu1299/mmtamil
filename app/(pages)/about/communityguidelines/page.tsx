...
import { getAboutUsData } from "../aboutus/api/api";
...
const CommunityGuidelines = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Sort the data in ascending order by heading
        ...
        setError("Unable to load Community Guidelines data.");
      } finally {
        setIsLoading(false);
      }
    };
  ...
  if (aboutUsData.length === 0) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        No content available for Community Guidelines.
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-8 md:gap-6 mt-5">
        ...
        <div className="col-span-5 mr-4 md:mr-8 lg:mr-16">
          <div className="flex-1 pl-4 pt-6">
            <p className="bg-black md:text-4xl text-xl md:font-bold  font-semibold text-white py-6 flex items-center justify-center mt-22">
              Transparency
            </p>
